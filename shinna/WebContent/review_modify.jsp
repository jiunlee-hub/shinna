...
<!-- 로그인 탭 -->
	...
	<div class="container mt-4 pt-4 clearfix">
		<div class="container pt-3 mt-5 pb-5 mb-4 conta2">
			<div class="h3" style="color: #B22222;">게시판 글수정</div>
				...
				<table class="table table-striped text-center h5">
					<tr>
						...
						<td>
							...
							name="subject" value="<%=article.getSubject() %>" maxlength="50" required="required" />
						</td>
					</tr>
					<tr>
						<td class="h5">
					...
					<tr>
						...
						<td>
							...
							maxlength="2048" required="required" style="height: 350px; resize: none;">
								<%=article.getContent() %>
							</textarea>
						</td>
					</tr>
