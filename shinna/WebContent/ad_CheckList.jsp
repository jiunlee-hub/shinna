					...
					<li class="nav-item " style="width:100%; ">
						<div class="dropdown lang">
	    					<button class="text-left btn btn-white dropdown-toggle" type="button"
								...
								aria-haspopup="true" aria-expanded="false" style="width:100%; "><img src="images/dia.png" alt="-" style="width:27px; height:27px;">
								<%
...
<div class="list mx-auto " style="width:1300px;">
	<span class="text-center" style="font-size:2em; ">예약관리</span>
	  ...
	  <tbody style="font-size:14px;">
	  	<%while(rs.next()){ %>
			<tr>
				...
				<td class="text-center"><a href="ad_CheckDelete.do?id=<%=rs.getString("id") %>" 
