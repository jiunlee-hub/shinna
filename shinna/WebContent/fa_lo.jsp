...
<div class="container fa">
	<div class="text-center mt-5 mb-5" >
		<h1 class="h1 font-weight-bold mb-5" style="color:#740000;">라 운 지</h1>
			<ul>
			 <li ><img class="picture1" src="images/lo01-1.jpg" alt="-"></li>
			 <li >
				 <img class="picture2" src="images/lo01.jpg" alt="-">
				 <img class="picture3" src="images/lo02.jpg" alt="-">
				 <img class="picture3" src="images/lo03.jpg" alt="-">
				 <img class="picture3" src="images/lo04.jpg" alt="-">
			 </li>
			</ul>	
	</div>
	<div class="h6 memo1 font-weight-bold">
		<div class="mt-5 list-unstyled memo2 mx-auto mb-5 ul-color" >
			...
			<li class="mb-3">위<span class="ml-4 mr-2"></span>치</li>
				<li class="mb-3 memo3" style="font-size:13px;">호텔 22F</li>
			<li class="mb-3">B&nbsp;&nbsp;A&nbsp;&nbsp;R</li> 
				<li class="mb-3 memo3" style="font-size:13px;">open - 19:00</li>
				<li class="mb-3 memo3" style="font-size:13px;">close - 02:00</li>
