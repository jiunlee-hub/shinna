...
<div class="member mx-auto " style="width:700px;">
	...
	<table class="table table-striped mt-4" style="width:700px">
	    ...
	    <tr  >
		      <th class="left font-weight-bold">아이디</th>
		      <td class="right"><%=rs.getString("id") %></td>
	     </tr>
	     <tr>
		      <th class="left font-weight-bold" >국적</th>
		      <td class="right"><%=rs.getString("country") %></td>
	     </tr>
	     <tr>
		      <th class="left font-weight-bold" >성명(한글)</th>
				<td class="right"><%=rs.getString("name") %></td>
	     </tr>
	     <tr>
		      <th class="left font-weight-bold">성명(영어)</th>
				<td class="right"><%=rs.getString("F_name") %> <%=rs.getString("L_name") %></td>
	     </tr>
	     <tr>
		      <th class="left font-weight-bold">비밀번호</th>
				<td class="right"><%=rs.getString("pw") %></td>
	     </tr>
	     <tr>
		      <th class="left font-weight-bold">생년월일</th>
	     ...
	     <tr>
		      <th class="left font-weight-bold">성별</th>
				<td class="right"><%=rs.getString("gender") %></td>
	    </tr>
	</table>
	<div class="text-center" id="joinbutton"> 
		<button type="submit"  id="joinbutton" class="btn btn-outline-success login-color2 form-control mt-3" style="width:100px;"onClick="location.href='index.do'">확인</button>
	</div>
		<% } %>	
</div>
