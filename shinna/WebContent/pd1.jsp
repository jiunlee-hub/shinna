...
<section class="container mt-5"> 
		<div class="text-center">
			<h1 class="h3 font-weight-bold">EARLY BIRD OFFER</h1>
<div class="card mb-3">
<img src="./images/bbed.jpg" class="card-img-top" alt="..." >
  <div class="card-body">
    <h2 class="card-title font-weight-bold h4">프로모션 상세정보</h2><br>
    <p class="card-text text-left h6">내용 │ 투숙일 14일 전까지 예약 시 혜택 적용</p>
    <p class="card-text text-left h6">금액 │ KRW 322,500~</p>
    <p class="card-text text-left h6">환불 │ 숙박예정일 7일 전까지는 위약금 없이 취소 가능</p>
    <br>
