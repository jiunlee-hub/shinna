...
<section class="container mt-5">
		<div class="text-center">
			<h1 class="h1 font-weight-bold">신나호텔 멤버스</h1>
<div class="card mb-3">
<img src="./images/member.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h2 class="card-title h2">More Stays, Better Rewards</h2>
    <p class="card-text">이제 신나호텔멤버스와 함께 당신의 여정에 신나회원만의 혜택을 더하세요!</p>
  </div>
</div>
</div>
</section>
...
<section class="bg-white text-dark mt-5 mb-3 pt-5 pb-4" > <!-- 객실소개 영역 -->
		...
		<div class="text-center">
			<h1 class="font-weight-bold h2">등급별 혜택 안내</h1>
			<hr>
			<br>
			<div class="col-4 text-left mb-5" style="max-width: 480px;">
				<h2 class="h2">Silver(SL)</h2>
				<ul class="mt-5 list-unstyled">
					<li class="mt-4">기본 적립률: 객실이용금액 1%, 식음이용금액 1%</li>
					<li class="mt-4">웰컴 드링크 매달 1회 제공</li>	
					<li class="mt-4">◦SL등급 조건│ 신규 회원 가입 시 적용</li>		
				</ul>
			</div>
			<hr>
			<div class="col-4 text-left mb-5" style="max-width: 480px;">
				<h2 class="h2">Gold(GL)</h2>
				<ul class="mt-5 list-unstyled">
					<li class="mt-4">기본 적립률+포인트추가 적립(객실3%, 식음 2%)</li>
					<li class="mt-4">투숙 시 멤버스 스위트박스 제공</li>
					<li class="mt-4">식음업장 이용금액 5%할인</li>
					<li class="mt-4">객실 연 3회 업그레이드(1회 한하여 스위트 객실 업그레이드)</li>
					<li class="mt-4">72시간 예약 개런티</li>
					<li class="mt-4">◦GL등급 조건│ 투숙횟수(10회), 투숙일수(25박)</li>				
				</ul>
			</div>
			<hr>
			<div class="col-4 text-left mb-5" style="max-width: 480px;">
				<h2 class="h2">Diamond(DL)</h2>
				<ul class="mt-5 list-unstyled">
					<li class="mt-4">기본 적립률 + 포인트 추가 적립 (객실 5%, 식음 3%)</li>
					<li class="mt-4">투숙 시 멤버스 스위트박스 제공</li>
					<li class="mt-4">식음업장 이용 금액 10% 할인</li>
					<li class="mt-4">객실 연 5회 업그레이드(1회 한하여 스위트 객실 업그레이드)</li>
					<li class="mt-4">Express Check-In/Check-Out</li>
					<li class="mt-4">Early Check-In (12시) Late Check-out (15시)</li>		
					<li class="mt-4">◦DL등급 조건│ 투숙횟수(20회), 투숙일수(50박)</li>		
				</ul>
			</div>
			</div>
		</div>
		<br>
		<div class="text-center">
		<a class="btn btn-danger btn-lg" href="Join.do" role="button">가입하기</a>
		</div>
	</section>
