...
if(request.getParameter("chkin") != null) chkin = request.getParameter("chkin");
if(request.getParameter("chkout") != null) chkout = request.getParameter("chkout");
if(request.getParameter("room") != null) room = Integer.parseInt(request.getParameter("room"));
...
if(request.getParameter("baby") != null) baby = Integer.parseInt(request.getParameter("baby"));
%>
<!DOCTYPE html>
<html>
<head>
...
<br>
	...
	<!-- 예약 -->
	<form action="ReservationProAction1.do" method="post">
		<div class="mx-auto">
			<div id="reservation" class="clearfix text-center mx-auto mb-5 mt-5">
				...
				<ul>
					...
					<li><select class="form-control" name="type">
							<option>객실선택</option>
							<option value="standard" <%if(type.equals("스탠다드")) out.println("selected='selected'"); %>>스탠다드</option>
							<option value="suite" <%if(type.equals("스위트")) out.println("selected='selected'"); %>>스위트</option>
							<option value="grand" <%if(type.equals("그랜드")) out.println("selected='selected'"); %>>그랜드</option>
							<option value="promotion1" <%if(type.equals("프로모션1")) out.println("selected='selected'"); %>>프로모션1</option>
							<option value="promotion2" <%if(type.equals("프로모션2")) out.println("selected='selected'"); %>>프로모션2</option>
							<option value="promotion3" <%if(type.equals("프로모션3")) out.println("selected='selected'"); %>>프로모션3</option>
							<option value="promotion4" <%if(type.equals("프로모션4")) out.println("selected='selected'"); %>>프로모션4</option>
							<option value="promotion5" <%if(type.equals("프로모션5")) out.println("selected='selected'"); %>>프로모션5</option>
							<option value="promotion6" <%if(type.equals("프로모션6")) out.println("selected='selected'"); %>>프로모션6</option>
				...
				<ul>
					...
					<li>
						<input class="date form-control" type="text" id="datepicker1" name="chkin"  value="<%=chkin %>"style="height:38px; font-size:15px;  text-align: center;">
					</li>
				</ul>
				<ul>
					<li class="mb-2 mt-2">체크아웃 </li>
					<li>
						<input class="date form-control" type="text" id="datepicker2" name="chkout" value="<%=chkout %>" style="height:38px; font-size:15px;  text-align: center;">
					</li>
				</ul>
				...
				<ul>
					...
					<li><select class="form-control" name="room">
							<option value="1" <%if(room==1)out.println("selected='selected'"); %>>1</option>
							<option value="2" <%if(room==2) out.println("selected='selected'"); %>>2</option>
							<option value="3" <%if(room==3) out.println("selected='selected'"); %>>3</option>
					</select></li>
				</ul>
				...
				<ul>
					...
					<li><select class="form-control" name="adult">
							<option value="1" <%if(adult==1)out.println("selected='selected'"); %>>1</option>
							<option value="2" <%if(adult==2) out.println("selected='selected'"); %>>2</option>
							<option value="3" <%if(adult==3) out.println("selected='selected'"); %>>3</option>
							<option value="3" <%if(adult==4) out.println("selected='selected'"); %>>4</option>
					</select></li>
				...
				<ul>
					...
					<li><select class="form-control" name="child">
							<option value="0" <%if(child==0)out.println("selected='selected'"); %>>0</option>
							<option value="1" <%if(child==1)out.println("selected='selected'"); %>>1</option>
							<option value="2" <%if(child==2) out.println("selected='selected'"); %>>2</option>
							<option value="3" <%if(child==3) out.println("selected='selected'"); %>>3</option>
					</select></li>
				...
				<ul>
					...
					<li><select class="form-control" name="baby">
							<option value="0" <%if(baby==0)out.println("selected='selected'"); %>>0</option>
							<option value="1" <%if(baby==1)out.println("selected='selected'"); %>>1</option>
							<option value="2" <%if(baby==2) out.println("selected='selected'"); %>>2</option>
							<option value="3" <%if(baby==3) out.println("selected='selected'"); %>>3</option>
					</select></li>
				</ul>
				<!-- 예약버튼 -->
				<ul>
					<li><input type="button" value="검색"
						class="btn btn-warning btn-lg mt-2" style="height: 63px;"></li>
				</ul>
			</div>
		</div>
	</form>
