...
<section class="container mt-5"> 
		<div class="text-center">
			<h1 class="h2 font-weight-bold">스위트룸 프로모션</h1>
<div class="card mb-3">
<img src="./images/bsuite.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h2 class="card-title font-weight-bold h4">프로모션 상세정보</h2><br>
    <p class="card-text text-left h6">내용 │ 스위트룸 프로모션으로 특별한 가을을 보내세요~</p>
    <p class="card-text text-left h6">금액 │ KRW (5%)335,000~</p>
    <p class="card-text text-left h6">혜택 │ 홈페이지 특별요금 대비5% 할인</p>
    ...
    <p class="card-text text-left"><small class="text-muted">◦선택일자의  객실이 없을 경우, 조회가 되지 않을 수 있습니다.</small></p>
  </div>
</div>
</div>
</section>
