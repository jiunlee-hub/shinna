...
<div class="container fa">
	<div class="text-center mt-5 mb-5" >
		<h1 class="h1 font-weight-bold mb-5" style="color:#740000;">레 스 토 랑</h1>
			<ul>
			 <li ><img class="picture1" src="images/re01-1.jpg" alt="-"></li>
			 <li >
				 <img class="picture2" src="images/re01.jpg" alt="-">
				 <img class="picture3" src="images/re02.jpg" alt="-">
				 <img class="picture3" src="images/re03.jpg" alt="-">
				 <img class="picture3" src="images/re04.jpg" alt="-">
			 </li>
			</ul>	
	</div>
	<div class="h6 memo1 font-weight-bold">
		<div class="mt-5 list-unstyled memo2 mx-auto mb-5 ul-color" >
			...
			<li class="mb-3">위<span class="ml-4 mr-2"></span>치</li>
				<li class="mb-3 memo3" style="font-size:13px;">호텔 2F</li>
			<li class="mb-3">운영시간</li> 
				<li class="mb-3 memo3" style="font-size:13px;">조식 (06:30 ~ 09:00)</li>
				<li class="mb-3 memo3" style="font-size:13px;">점심 (12:00 ~ 14:30)</li>
				<li class="mb-3 memo3" style="font-size:13px;">저녁 (17:30 ~ 22:00)</li>
