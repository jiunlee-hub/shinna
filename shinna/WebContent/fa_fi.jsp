...
<div class="container fa">
	<div class="text-center mt-5 mb-5" >
		<h1 class="h1 font-weight-bold mb-5" style="color:#740000;">휘트니스 센터</h1>
			<ul>
			 <li ><img class="picture1" src="images/fi01-1.jpg" alt="-"></li>
			 <li >
				 <img class="picture2" src="images/fi01.jpg" alt="-">
				 <img class="picture3" src="images/fi02.jpg" alt="-">
				 <img class="picture3" src="images/fi03.jpg" alt="-">
				 <img class="picture3" src="images/fi04.jpg" alt="-">
			 </li>
			</ul>	
	</div>
