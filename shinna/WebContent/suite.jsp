...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./images/ss1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="./images/ss2.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="./images/ss3.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
...
<div class="card mb-5">
  <div class="card-body">
    <h2 class="card-title font-weight-bold h3">스위트 룸</h2>
...
<div class="card mb-5">
  <div class="card-body">
    ...
    <p class="card-text h5">객실면적          73㎡</p>
