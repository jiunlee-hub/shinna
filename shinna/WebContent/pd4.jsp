...
<section class="container mt-5">
		<div class="text-center">
			<h1 class="h3 font-weight-bold">평일한정 특별요금</h1>
<div class="card mb-3">
<img src="./images/bweek.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h2 class="card-title font-weight-bold h4">프로모션 상세정보</h2><br>
    <p class="card-text text-left h6">내용 │ 일~목 툭숙 시 특별요금 혜택!</p>
    <p class="card-text text-left h6">금액 │ KRW 312,000~</p>
    <p class="card-text text-left h6">제외기간 │ 매주 토요일 및 성수기</p>
    ...
    <p class="card-text text-left"><small class="text-muted">◦객실 상황에 따라 상품운영이 제한될 수 있습니다.</small></p>
  </div>
</div>
</div>
</section>
