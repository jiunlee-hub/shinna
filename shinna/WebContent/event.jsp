...
<!-- 이벤트 소개 영역 -->
	<div class="jumbotron">
		<h1 class="display-4">호텔 이벤트</h1>
		<hr class="my-4"><p>신나호텔에서 준비한 특별한 이벤트!</p>
	</div>
	<div class="card text-center m-3">
		<div class="card-header">
			<ul class="nav nav-tabs card-header-tabs">
				<li class="nav-item"><a class="nav-link active" href="#">이벤트1</a></li>
				<li class="nav-item"><a class="nav-link" href="#">이벤트2</a></li>
				<li class="nav-item"><a class="nav-link" href="#">이벤트3</a></li>
			</ul>
		</div>
		<div class="card-body tab-info">
			<h4 class="card-title font-weight-bold h3">Wine Bazaar Event</h4>
			<p class="card-text h6">소믈리에가 추천하는 와인 구매 시 플레이팅 도마를 증정합니다!</p>
			<br>
			<a href="ed1.do" class="btn btn-warning">자세히 보러가기</a>
		</div>
		<div class="card-body d-none tab-info">
			<h4 class="card-title font-weight-bold h3">Sweet Moment</h4>
			<p class="card-text h6">오래도록 기억될 수 있는 추억을 만들어 드립니다.</p>
			<br>
			<a href="ed2.do" class="btn btn-secondary">자세히 보러가기</a>
		</div>
		<div class="card-body d-none tab-info">
			<h4 class="card-title font-weight-bold h3">Merry Christmas &amp; Happy New Year</h4>
			<p class="card-text h6">겨울 이벤트와 함께 따뜻한 연말연시 보내세요~</p>
			<br>
			<a href="ed3.do" class="btn btn-success">자세히 보러가기</a>
		</div>
	</div>
