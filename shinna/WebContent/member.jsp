...
<div>
	<div class="info mx-auto">
		<span class="text-center" style="font-size:2em;">회원정보</span><br>
		<hr><br>
				<div class="card  card-form my-4">
					<div class="card-body" style="background-color:#F1E3C4">
						<form name="memberInfo" action="memberPro.do" method="post">
							<div class="input-group mt-4 mb-4">
							  <div class="input-group-prepend ">
							    <span class="input-group-text font-weight-bold" id="basic-addon1" style="width:140px; height:42px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;아이디</span>
							  </div>
							  <input type="text" class="form-control font-weight-bold"  name="id" value=<%= id %> style="height:42px;" aria-label="Username" aria-describedby="basic-addon1">
							</div>		
							...
							<button type="submit" class="btn btn-outline-success font-weight-bold" style="width:150px;">확인</button>
							</div>
						</form>
					</div>
				</div>
