...
<section class="container mt-5">
		<div class="text-center">
			<h1 class="h2 font-weight-bold">Sweet Moment</h1>
<div class="card mb-3">
<img src="./images/plate.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h2 class="card-title font-weight-bold h3">이벤트 패키지 상세정보</h2>
    <p class="card-text text-left h5">내용 │ 미쉐린 3스타 셰프 야닉 알레노의 2인 디너 풀코스
    										 +스페셜 화이트 케이크&amp;로제 샴페인 와인+ 마카롱 패키지</p>
    <p class="card-text text-left h5">가격 │ KRW 799,000</p>
    <p class="card-text text-left h5">기간 │ 2020.12.01~2021.03.16</p>
    <p class="card-text text-left h5">대상 │ 신나호텔 회원</p>
    <p class="card-text text-left"><small class="text-muted">◦타 할인혜택과 중복 제공되지 않습니다.</small></p>
    <p class="card-text text-left"><small class="text-muted">◦상기 이미지는 이해를 돕기 위한 연출 컷입니다.</small></p>
  </div>
</div>
</div>
</section>
