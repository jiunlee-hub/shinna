...
<section class="container mt-4"> <!-- 소개 영역 -->
		<div class="text-center">
			<h1 class="h2 font-weight-bold">Wine Bazaar Event</h1>
<div class="card mb-3">
<img src="./images/doma.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h2 class="card-title font-weight-bold h3">이벤트 상세정보</h2>
    <p class="card-text text-left h5">내용 │ 소믈리에 추천와인 60여종 판매</p>
    <br>
    <p class="card-text text-left h5">장소 │ 1층 델리카한스 앞</p>
    <br>
    <p class="card-text text-left h5">증정 │ 리테일 와인 35만원 이상 구매 시 플레이팅 도마 증정</p>
    <br>
    <p class="card-text text-left"><small class="text-muted">◦사은품 한정수량으로 재고 소진 시 지급 종료됩니다.</small></p>
    <p class="card-text text-left"><small class="text-muted">◦당일 구매기준 1인 1개 지급</small></p>
  </div>
</div>
</div>
</section>
