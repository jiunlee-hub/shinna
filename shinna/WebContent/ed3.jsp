...
<section class="container mt-5"> 
		<div class="text-center">
			<h1 class="h2 font-weight-bold">Merry Christmas &amp; Happy New Year</h1>
<div class="card mb-3">
<img src="./images/tree.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h2 class="card-title font-weight-bold h3">이벤트 상세정보</h2>
    <p class="card-text text-left h5">세상에서 단 하나뿐인 나만의 크리스마스 케이크를 만들어보세요</p>
    <p class="card-text text-left h5">기간 │ 2020.12.20~2020.12.25</p>
    <p class="card-text text-left h5">장소 │연회장</p>
    <p class="card-text text-left h5">요금 │30,000원/1팀</p>
    <p class="card-text text-left h5">대상 │ 신나호텔 회원</p>
    <p class="card-text text-left"><small class="text-muted">◦신나호텔 투숙 고객 대상으로 진행되는 이벤트입니다.</small></p>
    <p class="card-text text-left"><small class="text-muted">◦상기 이벤트는 호텔 사정에 따라 변경 및 취소될 수 있습니다.</small></p>
  </div>
</div>
</div>
</section>
