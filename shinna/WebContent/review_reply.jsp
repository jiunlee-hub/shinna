...
<!-- 로그인 탭 -->
	...
	<div class="container mt-4 pt-4 clearfix">
		<div class="container pt-3 mt-5 pb-5 mb-4 conta2">
			<div class="h3" style="color: #B22222;">게시판 답글쓰기</div>
			<hr style="height: 2.5px;" color="black" />
			<form action="reviewReplyPro.do" method="post" name="reviewform">
			...
			<input type="hidden" name="seq" value="<%=article.getSeq() %>">
				<table class="table table-striped text-center h5">
					<tr>
						<td>
				...
				<hr/>
				<a href="reviewList.do" class="btn btn-success mr-2 float-left">목록</a>
				<a href="javascript:history.back()" class="btn btn-success float-left">본문</a>
				<button type="submit" class="btn btn-warning ml-2 float-right">답글등록</button>
				<button type="reset" class="btn btn-warning float-right">다시작성</button>
			</form>
		</div>
	</div>
