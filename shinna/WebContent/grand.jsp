...
<!-- 객실 사진 영역 -->
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel"> <!-- 객실 사진 영역 -->
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./images/gr1.jpg" class="d-block w-100 gar" alt="...">
    </div>
    <div class="carousel-item">
      <img src="./images/gr2.jpg" class="d-block w-100 gar" alt="...">
    </div>
    <div class="carousel-item">
      <img src="./images/gr3.jpg" class="d-block w-100 gar" alt="...">
    </div>
  </div>
...
<div class="card mb-5">
  <div class="card-body">
    <h2 class="card-title font-weight-bold h3" id="grand">[자쿠지]그랜드 룸</h2>
    <p class="card-text">신나호텔의 세련미와 우아함을 더한 고급스러운 인테리어로 구성되어 있는 고품격 객실입니다.</p>
    <p class="card-text">또한, 룸 안에 자쿠지가 구비되어 고품격 휴식을 즐기기에 충분합니다.</p>
  </div>
</div>
</div>
...
<div class="card mb-5">
  <div class="card-body">
    ...
    <p class="card-text h5">투숙인원          4명</p>
    <p class="card-text h5">객실면적          80㎡</p>
