...
<div class="container fa">
	<div class="text-center mt-5 mb-5" >
		<h1 class="h1 font-weight-bold mb-5" style="color:#740000;">샤 워 장</h1>
			<ul>
			 <li ><img class="picture1" src="images/sa01-1.jpg" alt="-"></li>
			 <li >
				 <img class="picture2" src="images/sa01.jpg" alt="-">
				 <img class="picture3" src="images/sa02.jpg" alt="-">
				 <img class="picture3" src="images/sa03.jpg" alt="-">
				 <img class="picture3" src="images/sa04.jpg" alt="-">
			 </li>
			</ul>	
	</div>
	<div class="h6 memo1 font-weight-bold">
		<div class="mt-5 list-unstyled memo2 mx-auto mb-5 ul-color" >
			...
			<li class="mb-3">이용안내</li> 
				...
				<li class="mb-3 memo3" style="font-size:13px;">이용요금 (대인 10,000원 / 소인 7,000원 / 0~24개월 무료이용)</li>
				<li class="mb-3 memo3" style="font-size:13px;">만 13세 미만 고객은 성인 보호자 동행없이 입장이 제한됩니다.</li>
